...
class SimpleCNN(nn.Module):
    """
    Simple CNN for multi-class segmentation
    (cloud / shadow / background)
    """

    def __init__(self, in_channels=3, base_channels=32, num_classes=3):
        super().__init__()
        ...
        # decoder (no skip connections → intentional)
